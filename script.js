...
$("#home-page,#store,#ipad-section,#mac-section,#iphone-section,#watch-section,#airpods-section,#tv-and-home-section").hide();

$(".nav-link").on("click", function () {
  $("#home-page,#store,#mac-section,#ipad-section,#iphone-section,#watch-section,#airpods-section,#tv-and-home-section,#entertainment-section").hide();
  $($(this).attr("href")).show();
});
